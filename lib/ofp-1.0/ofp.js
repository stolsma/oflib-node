...
module.exports = {
        ...
        "ofp_bad_request_code" : {
            ...
            "OFPBRC_BAD_VENDOR"     : 3,      /* Vendor not supported (in ofp_vendor_header
                                    : 4,       * or ofp_stats_request or ofp_stats_reply). */
            "OFPBRC_BAD_SUBTYPE"    : 5,      /* Vendor subtype not supported. */
            "OFPBRC_EPERM"          : 6,      /* Permissions error. */
            "OFPBRC_BAD_LEN"        : 7,      /* Wrong request length for type. */
            "OFPBRC_BUFFER_EMPTY"   : 8,      /* Specified buffer has already been used. */
            "OFPBRC_BUFFER_UNKNOWN" : 9       /* Specified buffer does not exist. */
        },
