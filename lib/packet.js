...
module.exports = {
  ...
  isEthNone: function isEthNone(buf, offset) {
  ...
  isEthAll: function isEthAll(buf, offset) {
  ...
  isIPv4None: function isIPv4None(buf, offset) {
    return buf.readUInt32BE(offset, true) == 0x00000000;
  },
  
  isIPv4All: function isIPv4All(buf, offset) {
    return buf.readUInt32BE(offset, true) == 0xffffffff;
  },
