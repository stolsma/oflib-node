...
module.exports = {
  unpack: function unpackOfp(buffer, offset) {
    if (!offset) {
      offset = 0;
    }
    ...
    switch (version) {
      ...
      case 0x02: 
        return msg11.unpack(buffer, offset);
      default: 
        return {
          error : {
  ...
  pack: function packOfp(obj, buffer, offset) {
    if (!offset) {
      offset = 0;
    } 
    ...
    switch(message.version)  {
      case 0x01 : 
        return msg10.pack(message, buffer, offset);
      case 0x02 : 
        return msg11.pack(message, buffer, offset);
      default:
        return {
          error : {
