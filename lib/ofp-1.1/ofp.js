...
module.exports = {
  ...
  "ofp_port_no" : {
    "OFPP_MAX"        : 0xffffff00,  /* Maximum number of physical switch ports. */

    /* Fake output "ports". */
    "OFPP_IN_PORT"    : 0xfffffff8,  /* Send the packet out the input port. This virtual port must be explicitly used
                                        in order to send back out of the input port. */
    "OFPP_TABLE"      : 0xfffffff9,  /* Submit the packet to the first flow tableo NB: This destination port can only be
  ...
  "ofp_config_flags" : {
    ...
    "OFPC_INVALID_TTL_TO_CONTROLLER" : 1 << 2, /* Send packets with invalid TTL ie. 0 or 1 to controller */
  },
   ...
   */
  "ofp_vlan_id" : {
    "OFPVID_ANY"  : 0xfffe, /* Indicate that a VLAN id is set but don't care about it's value. Note: only valid when
   ...
   */
  "ofp_match_type" : {
    "OFPMT_STANDARD"   : 0    /* The match fields defined in the ofp_match structure apply */
  },
  ...
  "ofp_group" : {
    ...
    "OFPG_ANY"        : 0xffffffff  /* Wildcard group used only for flow stats requests. Selects all flows regardless of
  ...
  "ofp_bad_request_code" : {
    ...
    "OFPBRC_BAD_EXPERIMENTER"  : 3,    /* Experimenter id not supported (in ofp_experimenter_header
  ...
  "ofp_bad_instruction_code" : {
    ...
    "OFPBIC_UNSUP_EXP_INST"        : 5    /* Specific experimenter instruction unsupported. */
  },
  ...
  "ofp_bad_match_code" : {
    ...
    "OFPBMC_BAD_WILDCARDS"      : 5,    /* Unsupported wildcard specified in the match. */
  ...
  "ofp_group_mod_failed_code" : {
    "OFPGMFC_GROUP_EXISTS"           : 0,   /* Group not added because a group ADD attempted to replace an
    ...
    "OFPGMFC_UNKNOWN_GROUP"          : 8    /* Group not modified because a group MODIFY attempted to modify a
                                               non-existent group. */
  },
